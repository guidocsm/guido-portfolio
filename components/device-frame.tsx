...
export function IPhoneFrame({
  ...
  return (
    ...
    >
      {/* iPhone outer shell */}
      <div className="relative rounded-[2.5rem] border-[6px] border-[#1a1a1a] bg-[#1a1a1a] shadow-2xl shadow-black/40">
...
export function MacBookFrame({
  ...
  return (
    ...
    >
      {/* Screen bezel */}
      <div className="relative rounded-t-xl border-[8px] border-[#1a1a1a] bg-[#1a1a1a] shadow-2xl shadow-black/40">
        {/* Camera dot */}
      ...
      {/* Base */}
      <div className="h-[4px] w-[115%] rounded-b-xl bg-[#1a1a1a] shadow-lg shadow-black/30" />
    </div>
  )
}
...
export function TerminalFrame({
  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-2xl border-[10px] border-[#2c2c2c] bg-[#2c2c2c] shadow-2xl shadow-black/50">
      ...
      {/* Wall mount plate */}
      <div className="h-[6px] w-[50px] rounded-sm bg-[#252525] shadow-md shadow-black/30" />
    </div>
  )
}
